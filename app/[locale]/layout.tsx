...
const metadata = {
  es: {
    ...
    keywords: "zkjon, Jon Imanol Ruiz Hermoso, Desarrollador Full-Stack, React, Next.js, TypeScript, JavaScript, Portfolio",
  },
  en: {
    title: "Jon Imanol Ruiz Hermoso Portfolio",
    description: "Professional portfolio of Jon Imanol Ruiz Hermoso, Full-Stack Developer specialized in modern frontend frameworks, MCP Servers creation and AI-First development.",
    keywords: "zkjon, Jon Imanol Ruiz Hermoso, Full-Stack Developer, React, Next.js, TypeScript, JavaScript, Portfolio",
  }
};
  ...
  return {
    ...
    other: {
      "application/ld+json": JSON.stringify({
        ...
        url: "https://zkjon.dev",
        sameAs: ["https://twitter.com/zkjondev", "https://github.com/zkjon", "https://www.linkedin.com/in/zkjon"],
