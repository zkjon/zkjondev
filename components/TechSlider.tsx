...
import {
  ...
  SiAstro, SiDeno, SiShelly, SiHibernate, SiSass, SiBun, SiPnpm, SiNpm, SiPrettier, SiCss3, SiBootstrap, SiPostgresql, 
...
const technologies = [
  ...
  { name: 'Hibernate', icon: SiHibernate, color: '#59666C', category: 'Database' },
